...
predefined_conversations = [
  {"customer": "商品はどれくらいの大きさですか？", "store": "【要確認】お問い合わせいただきありがとうございます。メーカーの方に問合せいたしますので今しばらくお待ちください。メーカーより返答があり、大きさは「確認」とのことでした。ご参考いただき購入を検討いただけますと幸いです。どうぞよろしくお願いいたします。"},
    ...
    {"customer": "お届け先を変更したい", "store": "この度は当店での商品のご購入、誠にありがとうございます。お問合せの件でご連絡をさせて頂きました。当店の受注システムが楽天にご登録してあるご住所に配送を行うため、商品はご注文を頂いた時点で、提携倉庫にて発送手続きに入っております。発送キャンセルが出来るか確認しますので、お待ちくださいませ。キャンセル処理ができない場合、お手数ではございますが、お客様にお荷物の受取拒否を行っていただく必要がございますので、ご了承ください。"},   
